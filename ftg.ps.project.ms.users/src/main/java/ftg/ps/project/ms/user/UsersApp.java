package ftg.ps.project.ms.user;

import ftg.ps.project.ms.user.client.OAuth2InterceptedFeignConfiguration;
import ftg.ps.project.ms.user.config.ApplicationProperties;
import ftg.ps.project.ms.user.config.DefaultProfileUtil;
